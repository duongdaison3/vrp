...
import "../css/QuizInstruction.css"
...
const QuizInstructions = () => (
    <Fragment>
        ...
        <div className="instructions container">
            ...
            <div>
                <span className="left" style={{ float : 'left' }}><Link to="/">No take me back</Link></span>
                <span className="right" style={{ float : 'right' }}><Link to="/quiz-play">Okay, Let's do this!</Link></span>
            </div>
        </div>
    </Fragment>
);
